...
var tokyoShuffleAv11280 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_av1_1280.M53TJJKN.webm";
var tokyoShuffleAv11920 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_av1_1920.JEYGU55K.webm";
var tokyoShuffleAv12560 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_av1_2560.YG63352H.webm";
var tokyoShuffleAv13840 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_av1_3840.UOOC4P46.webm";
var tokyoShuffleAv1426 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_av1_426.JK5LSFKI.webm";
var tokyoShuffleAv1640 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_av1_640.4OLUTIMJ.webm";
var tokyoShuffleAv1854 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_av1_854.XHGVYLR7.webm";
var tokyoShuffleH2641280 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_h264_1280.J67GTATZ.mp4";
var tokyoShuffleH2641920 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_h264_1920.6F7V2BR4.mp4";
var tokyoShuffleH2642560 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_h264_2560.YHRVA6IX.mp4";
var tokyoShuffleH2643840 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_h264_3840.KNSJILVI.mp4";
var tokyoShuffleH264426 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_h264_426.VFISIQ6E.mp4";
var tokyoShuffleH264640 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_h264_640.CEQXY2SD.mp4";
var tokyoShuffleH264854 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_h264_854.ITUZXYVP.mp4";
var tokyoShuffleVp91280 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_vp9_1280.7UWA7UEF.webm";
var tokyoShuffleVp91920 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_vp9_1920.TWOFCBB2.webm";
var tokyoShuffleVp92560 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_vp9_2560.4BS7KWUV.webm";
var tokyoShuffleVp93840 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_vp9_3840.3HBENYKS.webm";
var tokyoShuffleVp9426 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_vp9_426.F3AEY5ST.webm";
var tokyoShuffleVp9640 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_vp9_640.XXCE6N4F.webm";
var tokyoShuffleVp9854 = "assets/videos/hero/tokyo_shuffle/tokyo_shuffle_vp9_854.5DSVBDQ3.webm";
...
var VideoManager = class _VideoManager {
  ...
  initSubscriptions() {
    ...
    const statusSetter$ = state$.pipe(map(({ canPlay, prefersReducedMotion, currentSection }) => ({
      ...
      prefersReducedMotion,
      currentSection
    })), tap(({ prefersReducedMotion }) => this.handleReducedMotion({ prefersReducedMotion })), distinctUntilChanged((prev, cur) => prev.canPlay === cur.canPlay && prev.currentSection === cur.currentSection), debounceTime(100), tap(({ prefersReducedMotion, currentSection, canPlay }) => {
    ...
    const varSet$ = fromEvent(this.element, "loadedmetadata").pipe(filter((ev) => ev && ev.target instanceof HTMLMediaElement && elementInDom(ev.target)), map(({ target }) => target), take(1), tap((target) => {
    ...
    const playing$ = fromEvent(this.element, "playing").pipe(filter((ev) => {
      return ev.target instanceof HTMLMediaElement;
    }), distinctUntilKeyChanged("timeStamp"), tap(() => {
  ...
  loadPoster() {
    ...
    if (img && img instanceof HTMLImageElement) {
      if (img.complete) {
        ...
        fromEvent(this.poster, "load").pipe(take(1)).subscribe(() => {
          transition();
        });
      }
    } else {
  ...
  handleCanPlay() {
    ...
    switch (this.status) {
      case "not_initialized":
        ...
        break;
      case "loading":
        if (this.element.readyState <= 3 && (!this.element.duration || this.element.duration < 1 || !elementInDom(this.poster))) {
          this.loadSequence();
        } else {
          this.play();
        }
  ...
  mediaTimeline() {
    ...
    const ctaHeadings = gsapWithCSS.utils.toArray("h1, h2", this.ctaContainer);
    let duration = this.videoDuration, onUpdate = config6 && config6.onUpdate, tl = gsapWithCSS.timeline([
      "videoTimeline",
      {
        ...
        onComplete: () => {
          gsapWithCSS.set(this.element, { autoAlpha: 0, visibility: "hidden" });
        },
        callbackScope: this,
        paused: true,
        onUpdate() {
    ...
    tl.play = function() {
      ...
      if (arguments.length) {
        this["media"].currentTime = arguments[0];
      }
      return tl;
    };
    tl.restart = function() {
  ...
  initiateFallback() {
    if (this.status === "on_fallback" && elementInDom(this.backupPicture) && this.backupPicture.classList.contains("hero__poster--active")) {
      return;
    }
    this.loadBackup();
