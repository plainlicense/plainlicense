...
var HeroStore = class _HeroStore {
  ...
  constructor() {
    ...
    this.parallaxHeight$ = new BehaviorSubject(parseFloat((getViewportOffset().y * 1.4).toFixed(2)));
...
gsapWithCSS.registerEffect({
  ...
  effect: (targets, config6) => {
    ...
    return gsapWithCSS.timeline({ extendTimeline: true }).set(targets, { zIndex: 1, autoAlpha: 1, z: 1 }).fromTo([section.outerWrapper, section.innerWrapper], {
...
var scaleUp = (targets, config6 = {}) => {
  ...
  return gsapWithCSS.to(targets, { scale: 1.5, ease: "elastic", duration: 0.5, ...config6 });
};
gsapWithCSS.registerEffect({
  name: "emphasize",
  extendTimeline: true,
