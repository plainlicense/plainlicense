...
description: Plain License's mission provides simple, clear licenses for everyone.
---

# You deserve to understand

**Plain License's mission is to provide simple, clear licenses you and your users can understand.** We want to remove the complexity from licensing so you can focus on what you do best. We want to enable innovation and creativity by making it easy for your users to understand what they can and can't do with your work.

## Our story

**We noticed most popular licenses are too complex and hard to understand.** We believe licenses should be easy to understand for everyone, not just lawyers.
