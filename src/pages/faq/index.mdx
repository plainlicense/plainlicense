...
Many countries also have laws promoting plain language. In the United States, the Plain Writing Act of 2010 requires federal agencies to write "clear Government communication that the public can understand and use."<Footnote note="Take a close look at any recent instructions from the IRS and you'll see how much clearer they are than they used to be. We think that's a good thing, and we want to help make licenses clearer too." /> We think that's a good idea for everyone, not just the government. [Plainlanguage.gov][plainlanguage.gov] is a great resource for plain writing.
...
**There are a lot of licenses out there, and that can be confusing.** We think that's a problem, especially when the licenses are hard to understand. For example, the Free Software Foundation's GPL 3 requires [a very long faq][gpl-faq] just to explain how to use the license.<Footnote note="The GPL 3 is a great license, but it's very hard to understand. We applaud the FSF for their work providing clear answers to questions about the license. We think that's a great step in the right direction." />
...
[plain unlicense]: /licenses/public-domain/unlicense/ "Plain Unlicense"
