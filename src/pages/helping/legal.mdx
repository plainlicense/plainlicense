...
-   **Consider the risk**. Is the risk of legal misinterpretation *greater than the risk of people not understanding* the license? If so, we may need to adjust the language.<Footnote note="Most lawyers are trained to focus on the risk of legal misinterpretation. This risk assessment usually focuses on 'what has worked' before. There are two problems with this approach: (a) It drives lawyers to use complex language and jargon that has been used before, and assumes judges will interpret it the same way — but they don't always. We think plain language is more likely to be interpreted as intended, because it reflects what an average person would understand. (b) It doesn't consider the risk of people not understanding the license, which is a significant risk for most licenses." />
...
Any contributions, opinions, or suggestions you provide to Plain License are not legal advice and don't create a lawyer-client relationship. Your contributions are voluntary, informational, and for the benefit of the creative community.
...
2. You are not entering into a lawyer-client relationship with Plain License or its users.
