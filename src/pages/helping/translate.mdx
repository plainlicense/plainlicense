...
[i8]: /issues/8 "Issue #8: Implement multi-language support for licenses"
[i9]: /issues/9 "Issue #9: Integrate Material for MKDocs Internationalization"
[i10]: /issues/10 "Issue #10: Add Multilanguage Support for Site Content"
