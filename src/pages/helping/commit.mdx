...
You must provide all three, and they should all be lower case.
...
The ``scope`` for licenses should be the [SPDX identifier][spdx] (e.g., MIT, Apache-2.0) of the license you modified. For other changes, use the area of the project affected from the table above.
...
- `refactor(infra): reorganize ci/cd pipeline`
- `fix(ui): fix broken link in footer`
...
[issues]: /issues "Plain License issues"
[newissue]: /issues/new/choose "Create a new issue"
[discussions]: /discussions "Plain License discussions"
...
[plrepo]:  "Plain License repository"
