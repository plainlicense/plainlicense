...
const toUrl = (pathname: string) => {
  const modPathname = pathname.replace('~', '').replace('..', 'assets');
  return new URL(modPathname, origin);
};
...
export const rawHeroVideos = [
  {
    ...
    poster: {
      avif: {
        srcset: `${tokyoShuffleAvif3840} 3840w, ${tokyoShuffleAvif2560} 2560w, ${tokyoShuffleAvif1920} 1920w, ${tokyoShuffleAvif1280} 1280w, ${tokyoShuffleAvif854} 854w, ${tokyoShuffleAvif640} 640w, ${tokyoShuffleAvif426} 426w`,
        widths: {
          426: toUrl(tokyoShuffleAvif426),
          640: toUrl(tokyoShuffleAvif640),
          854: toUrl(tokyoShuffleAvif854),
          1280: toUrl(tokyoShuffleAvif1280),
          1920: toUrl(tokyoShuffleAvif1920),
          2560: toUrl(tokyoShuffleAvif2560),
          3840: toUrl(tokyoShuffleAvif3840),
        },
      },
      png: {
        srcset: `${tokyoShufflePng3840} 3840w, ${tokyoShufflePng2560} 2560w, ${tokyoShufflePng1920} 1920w, ${tokyoShufflePng1280} 1280w, ${tokyoShufflePng854} 854w, ${tokyoShufflePng640} 640w, ${tokyoShufflePng426} 426w`,
        widths: {
          426: toUrl(tokyoShufflePng426),
          640: toUrl(tokyoShufflePng640),
          854: toUrl(tokyoShufflePng854),
          1280: toUrl(tokyoShufflePng1280),
          1920: toUrl(tokyoShufflePng1920),
          2560: toUrl(tokyoShufflePng2560),
          3840: toUrl(tokyoShufflePng3840),
        },
      },
      webp: {
        srcset: `${tokyoShuffleWebp3840} 3840w, ${tokyoShuffleWebp2560} 2560w, ${tokyoShuffleWebp1920} 1920w, ${tokyoShuffleWebp1280} 1280w, ${tokyoShuffleWebp854} 854w, ${tokyoShuffleWebp640} 640w, ${tokyoShuffleWebp426} 426w`,
        widths: {
          426: toUrl(tokyoShuffleWebp426),
          640: toUrl(tokyoShuffleWebp640),
          854: toUrl(tokyoShuffleWebp854),
          1280: toUrl(tokyoShuffleWebp1280),
          1920: toUrl(tokyoShuffleWebp1920),
          2560: toUrl(tokyoShuffleWebp2560),
          3840: toUrl(tokyoShuffleWebp3840),
        },
      },
    },
    variants: {
      av1: {
        426: toUrl(tokyoShuffleAv1426),
        640: toUrl(tokyoShuffleAv1640),
        854: toUrl(tokyoShuffleAv1854),
        1280: toUrl(tokyoShuffleAv11280),
        1920: toUrl(tokyoShuffleAv11920),
        2560: toUrl(tokyoShuffleAv12560),
        3840: toUrl(tokyoShuffleAv13840),
      },
      h264: {
        426: toUrl(tokyoShuffleH264426),
        640: toUrl(tokyoShuffleH264640),
        854: toUrl(tokyoShuffleH264854),
        1280: toUrl(tokyoShuffleH2641280),
        1920: toUrl(tokyoShuffleH2641920),
        2560: toUrl(tokyoShuffleH2642560),
        3840: toUrl(tokyoShuffleH2643840),
      },
      vp9: {
        426: toUrl(tokyoShuffleVp9426),
        640: toUrl(tokyoShuffleVp9640),
        854: toUrl(tokyoShuffleVp9854),
        1280: toUrl(tokyoShuffleVp91280),
        1920: toUrl(tokyoShuffleVp91920),
        2560: toUrl(tokyoShuffleVp92560),
        3840: toUrl(tokyoShuffleVp93840),
      },
    },
  },
  {
    ...
    poster: {
      avif: {
        srcset: `${breakFreeAvif3840} 3840w, ${breakFreeAvif2560} 2560w, ${breakFreeAvif1920} 1920w, ${breakFreeAvif1280} 1280w, ${breakFreeAvif854} 854w, ${breakFreeAvif640} 640w, ${breakFreeAvif426} 426w`,
        widths: {
          426: toUrl(breakFreeAvif426),
          640: toUrl(breakFreeAvif640),
          854: toUrl(breakFreeAvif854),
          1280: toUrl(breakFreeAvif1280),
          1920: toUrl(breakFreeAvif1920),
          2560: toUrl(breakFreeAvif2560),
          3840: toUrl(breakFreeAvif3840),
        },
      },
      png: {
        srcset: `${breakFreePng3840} 3840w, ${breakFreePng2560} 2560w, ${breakFreePng1920} 1920w, ${breakFreePng1280} 1280w, ${breakFreePng854} 854w, ${breakFreePng640} 640w, ${breakFreePng426} 426w`,
        widths: {
          426: toUrl(breakFreePng426),
          640: toUrl(breakFreePng640),
          854: toUrl(breakFreePng854),
          1280: toUrl(breakFreePng1280),
          1920: toUrl(breakFreePng1920),
          2560: toUrl(breakFreePng2560),
          3840: toUrl(breakFreePng3840),
        },
      },
      webp: {
        srcset: `${breakFreeWebp3840} 3840w, ${breakFreeWebp2560} 2560w, ${breakFreeWebp1920} 1920w, ${breakFreeWebp1280} 1280w, ${breakFreeWebp854} 854w, ${breakFreeWebp640} 640w, ${breakFreeWebp426} 426w`,
        widths: {
          426: toUrl(breakFreeWebp426),
          640: toUrl(breakFreeWebp640),
          854: toUrl(breakFreeWebp854),
          1280: toUrl(breakFreeWebp1280),
          1920: toUrl(breakFreeWebp1920),
          2560: toUrl(breakFreeWebp2560),
          3840: toUrl(breakFreeWebp3840),
        },
      },
    },
    variants: {
      av1: {
        426: toUrl(breakFreeAv1426),
        640: toUrl(breakFreeAv1640),
        854: toUrl(breakFreeAv1854),
        1280: toUrl(breakFreeAv11280),
        1920: toUrl(breakFreeAv11920),
        2560: toUrl(breakFreeAv12560),
        3840: toUrl(breakFreeAv13840),
      },
      h264: {
        426: toUrl(breakFreeH264426),
        640: toUrl(breakFreeH264640),
        854: toUrl(breakFreeH264854),
        1280: toUrl(breakFreeH2641280),
        1920: toUrl(breakFreeH2641920),
        2560: toUrl(breakFreeH2642560),
        3840: toUrl(breakFreeH2643840),
      },
      vp9: {
        426: toUrl(breakFreeVp9426),
        640: toUrl(breakFreeVp9640),
        854: toUrl(breakFreeVp9854),
        1280: toUrl(breakFreeVp91280),
        1920: toUrl(breakFreeVp91920),
        2560: toUrl(breakFreeVp92560),
        3840: toUrl(breakFreeVp93840),
      },
    },
  },
] as HeroVideo[];
