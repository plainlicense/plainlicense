...
export const PERMISSION_WHY: Record<string, string> = {
  'commercial-use': 'So you can build a business or earn income with this work.',
  ...
  'patent-use':     'So you can use this work without fear of patent claims from contributors.',
...
export const CONDITION_WHY: Record<string, string> = {
  ...
  'include-copyright--source': 'So the original creator gets credit for their work.',
  'network-use-disclose':      'Because sharing over a network is still sharing the work.',
